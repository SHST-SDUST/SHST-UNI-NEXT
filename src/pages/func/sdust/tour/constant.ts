...
export const DEFAULT_LATITUDE = 36.0033064857;
export const DEFAULT_LONGITUDE = 120.124104023;
...
export const TOUR_CONFIG: TourConfig = [
  {
    ...
    data: [
      { name: "图书馆(原花海)", latitude: 36.0033064857, longitude: 120.124104023 },
      ...
      { name: "风雨操场", latitude: 36.006040464, longitude: 120.1259493828 },
  ...
  },
  {
    ...
    data: [
      ...
      { name: "J3外国语学院", latitude: 36.00124, longitude: 120.1255 },
      { name: "J4矿业学院", latitude: 35.9992140203, longitude: 120.1220709085 },
      { name: "J5教学楼", latitude: 36.001209, longitude: 120.127437 },
      {
      ...
      { name: "J8机电学院楼", latitude: 35.9991923206, longitude: 120.1209443808 },
      {
        ...
        latitude: 36.001336,
        longitude: 120.128402,
      },
      { name: "J11自动化学院、电信学院", latitude: 36.002208528, longitude: 120.1285403967 },
  ...
  },
  {
    ...
    data: [
      { name: "南门", latitude: 35.99944, longitude: 120.12485 },
      { name: "北门", latitude: 36.0078, longitude: 120.12313 },
    ],
  },
  {
    scale: 15,
  ...
  },
  {
    ...
    data: [
      ...
      { name: "A5-7", latitude: 36.00597971, longitude: 120.1246297359 },
      ...
      { name: "A19-21", latitude: 36.0067478112, longitude: 120.12403965 },
      { name: "A18-20", latitude: 36.0064917783, longitude: 120.122564435 },
      { name: "A12", latitude: 36.0058929184, longitude: 120.1227092743 },
      { name: "A14-A16", latitude: 36.006418006, longitude: 120.1222372055 },
      ...
      { name: "C10", latitude: 36.0054763175, longitude: 120.117559433 },
      { name: "C12", latitude: 36.0059232955, longitude: 120.1176452637 },
      { name: "C14", latitude: 36.00637895, longitude: 120.1175969839 },
      { name: "C11", latitude: 36.0052636766, longitude: 120.1189273596 },
      { name: "C16-18", latitude: 36.0050640541, longitude: 120.1179671288 },
      { name: "C5-7-9", latitude: 36.006161972, longitude: 120.1188737154 },
      { name: "C13", latitude: 36.0055934867, longitude: 120.118508935 },
  ...
  },
  {
    ...
    data: [
      ...
      { name: "C区篮球场", latitude: 36.004482542, longitude: 120.1215666533 },
      ...
      { name: "行政楼", latitude: 35.99986067, longitude: 120.1234602928 },
    ],
  },
];
